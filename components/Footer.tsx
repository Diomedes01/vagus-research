    ...
    <footer className="bg-bg-dark text-white">
      <div className="max-w-layout mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-mono text-[11px] font-medium tracking-[0.1em] uppercase text-white/70 mb-4">
              Navigate
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <p className="text-xs text-white/60 leading-relaxed max-w-3xl">
            <strong className="text-white/70">Medical Disclaimer:</strong> The content on this website is for
