...
- **Transdiagnostic applications** examining whether the autonomic rebalancing effects of taVNS may benefit not only anxiety disorders but also related conditions characterised by autonomic dysregulation (depression, PTSD, insomnia, and [addiction](/library/vns-and-addiction), where stress-driven craving shares overlapping neural circuitry with anxiety)
