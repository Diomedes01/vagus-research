...
featured: true
image: "/images/articles/vns-guide-hero.png"
faq:
  - question: "What is vagus nerve stimulation (VNS)?"
    answer: "Vagus nerve stimulation is a neuromodulation technique that delivers mild electrical impulses to the vagus nerve to influence brain activity and autonomic function. It is used to treat conditions including epilepsy, depression, anxiety, and chronic inflammation."
  - question: "How does vagus nerve stimulation work?"
    answer: "VNS works by sending electrical signals along the vagus nerve to the brainstem, which then modulates activity in brain regions involved in mood, arousal, and autonomic regulation. This promotes parasympathetic activation — the body's rest-and-digest response."
  - question: "What is the difference between invasive and non-invasive VNS?"
    answer: "Invasive VNS (iVNS) requires surgical implantation of an electrode around the cervical vagus nerve. Non-invasive VNS, such as transcutaneous auricular VNS (taVNS), stimulates the vagus nerve through the skin of the ear using a small external device — no surgery required."
  - question: "What conditions can vagus nerve stimulation treat?"
    answer: "VNS is FDA-approved for epilepsy and treatment-resistant depression. Research is also exploring its potential for anxiety, PTSD, chronic pain, inflammation, migraine, stroke rehabilitation, tinnitus, and gut-related conditions."
---
...
VNS enhances **vagal tone** — the degree of activity in the parasympathetic nervous system mediated by the vagus nerve. Low vagal tone, often measured through [heart rate variability (HRV)](/library/vns-and-hrv), has been associated with a range of conditions including anxiety, depression, [heart failure](/library/vns-for-heart-failure), and chronic inflammation (Thayer & Lane, 2000).
...
In 2005, the FDA approved iVNS for **treatment-resistant depression (TRD)** — defined as major depression that has not responded to at least four adequate antidepressant treatments. The pivotal study by Rush et al. (2005) showed modest acute benefits, but long-term observational data revealed more substantial improvements over 12 months compared to treatment-as-usual. We explore the full body of evidence in our dedicated review of [VNS for depression](/library/vns-for-depression).
...
- **Anxiety disorders** — Several randomised controlled trials have reported that taVNS may reduce both state and trait anxiety (Burger et al., 2020). For a detailed analysis, see our article on [vagus nerve stimulation for anxiety](/library/vns-for-anxiety)
