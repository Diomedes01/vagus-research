...
featured: false
image: "/images/articles/vns-tinnitus-hero.png"
---
...
The distinguishing feature of VNS-paired tone therapy is its **specificity**: it is the only approach designed to reverse the precise neural reorganisation that generates tinnitus, leveraging endogenous neuromodulatory systems to drive controlled, targeted cortical plasticity. This same principle of targeted plasticity therapy has been applied successfully in [stroke rehabilitation](/library/vns-for-stroke), where VNS paired with movement practice drives motor cortex reorganisation.
