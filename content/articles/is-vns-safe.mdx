...
featured: true
image: "/images/articles/vns-safety-hero.png"
faq:
  - question: "Is vagus nerve stimulation safe?"
    answer: "Yes, research across 177 studies involving over 6,300 participants shows that vagus nerve stimulation — particularly non-invasive forms like taVNS — has an excellent safety profile with no serious adverse events reported in the non-invasive studies reviewed."
  - question: "What are the side effects of vagus nerve stimulation?"
    answer: "The most commonly reported side effects of non-invasive VNS are mild and transient, including tingling or discomfort at the stimulation site, headache, and skin irritation. Invasive VNS may also cause voice changes and coughing during stimulation."
  - question: "Is non-invasive vagus nerve stimulation (taVNS) safer than invasive VNS?"
    answer: "Non-invasive VNS has a more favourable safety profile than invasive VNS because it does not require surgery. The Kim et al. 2022 meta-analysis found zero serious adverse events across non-invasive VNS studies, compared to a small number associated with the surgical procedure in invasive VNS."
---

## Introduction: Why Safety Matters in Neuromodulation

Any therapy that modulates the nervous system — whether pharmacological or device-based — demands rigorous safety evaluation. For [vagus nerve stimulation (VNS)](/library/what-is-vns), this is particularly important because the vagus nerve influences heart rate, respiration, digestion, and [immune function](/library/vns-and-inflammation). Understanding the safety profile of VNS is not merely an academic exercise; it is essential for clinicians, researchers, and individuals seeking evidence-based information.
...
Invasive VNS has the longest clinical track record, with [FDA approval for epilepsy](/library/vns-for-epilepsy) dating to 1997. Because iVNS involves surgical implantation of a pulse generator and electrode lead, its side effect profile includes both **stimulation-related** and **procedure-related** effects.
...
Ardesch, J.J. et al. (2007). Vagus nerve stimulation for medically refractory epilepsy: a long-term follow-up study. *Seizure*, 16(7), 579–585.
...
Badran, B.W. et al. (2020). Transcutaneous auricular vagus nerve stimulation-paired rehabilitation for oromotor feeding problems in newborns: an open-label pilot study. *Frontiers in Human Neuroscience*, 14, 77.
