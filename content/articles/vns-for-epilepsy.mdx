...
featured: false
image: "/images/articles/vns-epilepsy-hero.png"
---
...
In 1985, Jacob Zabara proposed exactly this, demonstrating in animal models that intermittent [vagus nerve stimulation](/library/what-is-vns) could suppress seizure activity (Zabara, 1985). The first human implant followed in 1988, and the FDA approved VNS therapy for drug-resistant epilepsy in 1997. This article reviews the evidence that underpins this approval, the evolution of VNS therapy for epilepsy, and the emerging role of non-invasive approaches.
...
The [safety of transcutaneous approaches](/library/is-vns-safe) has been documented in a systematic review by Kim et al. (2022), which found that taVNS was generally well-tolerated with only mild, transient side effects.
